...
Page.create! name: 'index',
             path: '/pages/index',
             title: 'Главная',
             html: '<p><strong>Как определиться с будущей профессией?</strong><br /> В какой-то момент каждый человек задаётся этим вопросом.</p>
...
Page.create! name: 'student',
             ...
             html: '<p><a href="http://ipm.ifmo.ru/practice/">Информация</a> по практике для студентов 2-го и 3-го курсов.</p>
                    <p><a href="http://ipm.ifmo.ru/programming16-1/">Материалы</a> по дисциплине &#171;Программирование&#187; (1 курс ИПМ).</p>
...
Page.create! name: 'graduate',
             ...
             html: '<p><strong>Информация для магистрантов и бакалавров</strong></p>
                    <ol>
                    <li>Часто задаваемые <a href="http://ipm.ifmo.ru/вопрос-ответ">вопросы</a></li>
                    <li><a href="http://edu.ifmo.ru/pages/33/" target="_blank">Заявление </a>на утверждение темы ВКР</li>
                    <li>Документы, необходимые для оформления ВКР доступны по <a href="http://edu.ifmo.ru/pages/33/" target="_blank">ссылке</a></li>
                    <li><a href="http://edu.ifmo.ru/file/pages/14/trebovaniya_k_vypusknym_kvalifikacionnym_rabotam.pdf" target="_blank">Требования</a> к выпускным квалификационным работам</li>
                    <li>План работ и содержание ВКР бакаларов (<a href="http://ipm.ifmo.ru/wp-content/uploads/2016/02/Informatsia_dlya_bakalavrov.pdf">ссылка</a>).</li>
                    <li><a href="https://www.google.ru/url?sa=t&#038;rct=j&#038;q=&#038;esrc=s&#038;source=web&#038;cd=3&#038;ved=0ahUKEwjiuMHh743MAhWH1ywKHRVvBmcQFggoMAI&#038;url=http%3A%2F%2Fwww.ifmo.ru%2Ffile%2Fstat%2F161%2Fblank_zayvl_mag_dissert.doc&#038;usg=AFQjCNEHssvaxDO89pW2BZ2PR29BuD1ROg&#038;bvm=bv.119408272,d.bGg" target="_blank">Заявление</a>  о проверке ВКР в системе &#171;Антиплагиат&#187;</li>
                    <li>Положение о проверке в системе &#171;Антиплагиат&#187; <a href="http://edu.ifmo.ru/file/pages/14/prikaz_373-od.pdf" target="_blank">для специалистов/бакалавров<br />
                    </a>Положение о проверке в системе &#171;Антиплагиат&#187; <a href="https://www.google.ru/url?sa=t&#038;rct=j&#038;q=&#038;esrc=s&#038;source=web&#038;cd=1&#038;cad=rja&#038;uact=8&#038;ved=0ahUKEwi2-In0qtTMAhXFCiwKHYFZBOsQFggbMAA&#038;url=http%3A%2F%2Fwww.ifmo.ru%2Ffile%2Fstat%2F164%2Fpoloj_plagiat_2013.pdf&#038;usg=AFQjCNEEmdYioZlQN2fXoANg6l1i5cFrQA&#038;sig2=EsHHMPvzQM-xtCkr66ZwhQ&#038;bvm=bv.121658157,d.bGg" target="_blank">для магистров</a></li>
                    <li>Шаблон презентаций доступен на сайте <a href="http://isu.ifmo.ru" target="_blank">isu.ifmo.ru</a><br />
                    Университет->Корпоративная стилистика->Презентации<br />
                    <a href="http://edu.ifmo.ru/file/pages/211/rekomendacii_po_oformleniyu_elektronnyh_prezentaciy.pdf" target="_blank">Рекомендации</a> по оформлению электронной презентации</li>
                    </ol>'
...
Page.create! name: 'contacts',
             ...
             html: 'h4>Контактная информация</h4>
                    ...
                    <b>Телефон кафедры:</b> 233-46-90<br />
                    <b>Группа vk:</b> <a href="https://vk.com/ipm.ifmo" target="_blank">https://vk.com/ipm.ifmo</a></p>'
